  ...
  return (
    <section id="average-review" className="row rounded-3 p-2 mt-5 mx-1">
      <div className="col-lg d-flex flex-column align-items-center align-items-lg-start pb-3 pb-lg-0">
        <h2 className="fw-normal lh-base fs-5 my-1">What {reviews} people are saying</h2>
        <div className="d-flex align-items-center gap-1">
          ...
          <p className="stars-text miz-text-grey ms-2 my-2">{starCount} based on recent ratings</p>
        </div>
      </div>
